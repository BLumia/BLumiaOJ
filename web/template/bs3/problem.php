...
echo "</center>";
echo "<h2>$MSG_Description</h2><div class=panel panel-default>".$row->description."</div>";
echo "<h2>$MSG_Input</h2><div class=panel panel-default>".$row->input."</div>";
echo "<h2>$MSG_Output</h2><div class=panel panel-default>".$row->output."</div>";
