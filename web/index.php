...
///////////////////////////MAIN	
	...
	if (!$result){
		...
		$view_news.= "<div>";
		$loop = 1; $newsStyle = "panel-info";
		while ($row=mysql_fetch_object($result)){
			if ($loop == 1) $newsStyle = "panel-primary"; else $newsStyle = "panel-info";
			$view_news.= "<div class='panel ".$newsStyle."' width=96%><div class='panel-heading'><h3 class='panel-title'>".$row->title." -- by ".$row->user_id."</h3></div>";
			$view_news.= "<div class='panel-body'>".$row->content."</div></div>";
			$loop++;
		}
