...
<div style="text-align:left;font-size:80%">
	<a class="button green" href="newpost.php
	<?php 
	...
	<?php if ($pid!=null && $pid!=0 && ($cid=='' || $cid==null)){?>
		<a class="button" style="float:right;" href="../problem.php?id=<?php echo $pid?>">See the problem</a>
	<?php }?>
</div>
...
if (array_key_exists("pid",$_REQUEST)&&$_REQUEST['pid']!=''){
  $sql.=" AND ( `pid` = '".mysql_real_escape_string($_REQUEST['pid'])."' OR `top_level` >= 2 )";
  $level="";
}
else
