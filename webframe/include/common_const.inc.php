<?php 
	...
	*/
	...
	$JUDGE_RESULT=Array(L_JUDGE_PD,"MSG_PR",L_JUDGE_CI,L_JUDGE_RG,L_JUDGE_AC,L_JUDGE_PE,L_JUDGE_WA,L_JUDGE_TLE,L_JUDGE_MLE,L_JUDGE_OLE,L_JUDGE_RE,L_JUDGE_CE,"MSG_CO","MSG_TR");
