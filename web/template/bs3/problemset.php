...
<?php echo $MSG_PROBLEM_ID?>: <input class="input-small search-query" type='text' name='id' size=10 style="height:24px">
<button class="btn btn-mini" type='submit' ><?php echo $MSG_SEARCH?></button></form>
</td>
<td width='50%' colspan='1'>
<form class="form-search">
<?php echo $MSG_TITLE?><input style="height:24px" type="text" name=search class="input-large search-query" size=15>
