...
<thead>
<tr align=center class=toprow ><td>PROBLEM<td>AC<td>PE<td>WA<td>TLE<td>MLE<td>OLE<td>RE<td>CE<td>Total<td><td>C<td>C++<td>Pascal<td>Java<!--<th>Ruby<th>Bash<th>Python<th>PHP<th>Perl<th>C#<th>Obj-c<th>FreeBasic--></tr>
</thead>
<tbody>
<?php
for ($i=0;$i<$pid_cnt;$i++){
